  ...
  QBCore.Functions.TriggerCallback('qb-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
      if DoesEntityExist(pedcow1) then
        TriggerEvent('animations:client:EmoteCommandStart', {"Boxing2"})
        QBCore.Functions.Progressbar('killing_cow', Config.Alerts['killing_cow'], 1000, false, true, { -- Name | Label | Time | useWhileDead | canCancel
          disableMovement = true,
          disableCarMovement = true,
          disableMouse = false,
          disableCombat = true,
...
RegisterNetEvent('qb-simplefarming:killpig12', function()
  QBCore.Functions.TriggerCallback('qb-simplefarming:weapon_knife', function(hasItem)
    if hasItem then
      ...
      TriggerEvent('animations:client:EmoteCommandStart', {"Medic"})
        QBCore.Functions.Progressbar('Killing_Pig', Config.Alerts['killing_pig'], 5000, false, true, { -- Name | Label | Time | useWhileDead | canCancel
          disableMovement = true,
          disableCarMovement = true,
          disableMouse = false,
          disableCombat = true,
